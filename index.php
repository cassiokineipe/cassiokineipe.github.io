   ...
   <header id="home">
      ...
      <div class="row banner">
         <div class="banner-text">
            ...
            <h3>Sou um estudante de <span>Ciência da computação no Mackenzie</span>, tenho 19 anos e apresento aqui um pouco sobre mim. </a>
          </h3>
   ...
   <section id="about">
      ...
      <div class="row">
         ...
         <div class="three columns">
            ...
            <img class="profile-pic"  src="images/eu.jpg" alt="" />
         ...
         <div class="nine columns main-col">
            ...
            <p style="color: #fff;">Gosto de usar a lógica para resolver problemas, prefiro trabalhar em equipe do que sozinho, dependendo da equipe claro. Sou mais focado no  back end dos projetos.
      ...
      <div class="row education">
         ...
         <div class="nine columns main-col">
               ...
               <div class="twelve columns">
                  ...
                  <h3>Wizard, Arujá </h3>
                  <p class="info" style="color: #6959CD;">TOEIC 595: Inglês <span>&bull;</span> <em class="date">2015 - 2020</em></p>
            ...
            <div class="row item">
               ...
               <div class="twelve columns">
                  ...
                  <p class="info" style="color: #6959CD;"> Ensino fundamental / Médio   <span>&bull;</span> <em class="date">2018</em></p>
            ...
            <div class="row item">
               ...
               <div class="twelve columns">
                  ...
                  <p class="info" style="color: #6959CD;">B.A Ciência da Computação  <span>&bull;</span> <em class="date">2022</em></p>
         ...
         <div class="nine columns main-col">
            ...
            <div class="row item">
               ...
               <div class="twelve columns">
                  ...
                  <p class="info" style="color: #6959CD;">Auxiliar De Escritório   <span>&bull;</span> <em class="date"> 	 04/2017 - 06/2019 </em></p>

                  <p>
Como auxiliar de escritório trabalhei dando suporte ao departamento de produção e qualidade das ligas de alumínio elaborando análises do produto final e matéria prima.
...
com base nas solicitações dos clientes.
            ...
            <div class="row item">
               ...
               <div class="twelve columns">
                  ...
                  <h3>Indústria e Comércio de Metais Capixaba Ltda </h3>
                  <p class="info" style="color: #6959CD;">Desenvolvedor De Software Junior   <span>&bull;</span> <em class="date">07/2019 - Atual</em></p>

                  <p>
Atualmente trabalho no desenvolvimento de aplicações web utilizando as linguagens PHP, SQL, HTML e CSS para a elaboração de programas para o gerenciamento de PCP (Planejamento de Controle e Produção), ferramenta de gestão de pessoas, controle financeiro e estoque de peças/equipamentos.
...
A meta é fazer a rota 66 um dia.
         ...
         <div id="modal-03" class="popup-modal mfp-hide">
		      ...
		      <div class="description-box">
               ...
               <span class="categories"><i class="fa fa-tag"></i>Poker, Truco, fodinha, Tranca, Rummikub, Presidente </span>
		      </div>
         ...
         <div id="modal-06" class="popup-modal mfp-hide">
		      ...
		      <div class="description-box">
			      <h4>Metalurgia </h4>
			      <p>Tenho certo conhecimento prático em química metalúrgica por ter sido meu primeiro trabalho, bons tempos.</p>
         ...
         <div id="modal-07" class="popup-modal mfp-hide">
		      ...
		      <div class="description-box">
			      <h4>Mecânica</h4>
			      <p>Quando algo dá problema e ninguém na casa manja, sobra pra mim e nessa aprendi algumas coisa sobre mecânica.</p>
   ...
   <footer>
      ...
      <div class="row" >
         ...
         <div id="go-top"><a class="smoothscroll" title="Back to Top" href="#home"style="background-color: #6959CD;"><i class="icon-up-open" style="background-color: #6959CD;"></i></a></div>
